// cloudfunctions/initData/seed.js
// 云数据库种子数据（与小程序端 utils/mock.js 的美食数据保持一致）
// 注意：更新菜品后，两处数据需同步；可重新调用 initData 云函数覆盖写入
const foods = [
  // 一食堂一楼
...
const links = [
  { id: 'lk_001', name: '瑞幸咖啡（泉州纺织服装职业学院店）', emoji: '🥤', type: '咖啡饮品', price: '9.9-15 元', url: '#小程序://瑞幸咖啡/PflsdqPckhMdA8o', appId: 'wx21c7506e98a2fe75', reason: '招牌生椰拿铁，价格实惠', category: '链接', tags: ['招牌', '咖啡', '可跳转'] },
  { id: 'lk_002', name: '蜜雪冰城（纺织学院店）', emoji: '🍦', type: '饮品冰淇淋', price: '4-7 元', url: '#小程序://蜜雪冰城/aCuAAyZxIctGJHy', appId: 'wx10cabce5fb1f4933', reason: '冰鲜柠檬水 4 元，性价比之王', category: '链接', tags: ['平价', '解渴', '可跳转'] },
  { id: 'lk_003', name: '库迪咖啡（泉州纺织服装学院店）', emoji: '☕', type: '咖啡饮品', price: '9.9-15 元', url: '#小程序://库迪咖啡/5Za7KeFgTMpAtf', appId: 'wxde8ac0a21135c07d', reason: '潘帕斯蓝生酪拿铁，颜值担当', category: '链接', tags: ['咖啡', '颜值', '可跳转'] }
];

module.exports = { foods, canteens, brands, streets, links };
